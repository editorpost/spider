...
func Start(args *config.Args, deploy *setup.Deploy, extractors ...extract.PipeFn) error {
...
func Crawler(args *config.Args, deploy *setup.Deploy, extractors ...extract.PipeFn) (*collect.Crawler, error) {
